...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setGeometry(QRect(292, 21, 109, 23));
        layoutWidget1 = new QWidget(groupBox_2);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(12, 21, 181, 22));
        horizontalLayout_2 = new QHBoxLayout(layoutWidget1);
        horizontalLayout_2->setSpacing(6);
        horizontalLayout_2->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_2->setObjectName(QStringLiteral("horizontalLayout_2"));
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        SelectVariant_label = new QLabel(layoutWidget1);
        SelectVariant_label->setObjectName(QStringLiteral("SelectVariant_label"));

        horizontalLayout_2->addWidget(SelectVariant_label);

        SelectVariant_comboBox = new QComboBox(layoutWidget1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QApplication::translate("MainWindow", "  Generate CFG Files ", nullptr));
